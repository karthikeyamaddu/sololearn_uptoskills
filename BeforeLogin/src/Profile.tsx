...
const ProfileHeader = () => (
  <div className="w-full text-white py-10 px-5 rounded-b-3xl text-center">
    <div className="flex gap-[4%]">
      <img height={120} width={120} src="https://imgcdn.stablediffusionweb.com/2024/9/24/ed4d3b06-90f7-4d8d-ae20-9e6059147870.jpg" alt="profile picture" className="rounded-full w-[18%]" />
      <div className="text-left font-bold">
        <h2 className="text-2xl">Angad Gupta</h2>
        <p className="flex items-center gap-2 mt-[4%]">
          <span className="text-gray-200 cursor-pointer hover:text-white">1 Following</span>
          <span className="text-white cursor-default">0 Followers</span>
        </p>
        ...
        <p className="flex items-center gap-2 mt-[2%]">
          <IN title="India" className="h-3" />India . Lvl 1
        </p>
      </div>
    </div>
  </div>
...
const StreakTracker = () => {
  return (
    <div className="bg-white shadow-md rounded-lg p-6 w-full border border-gray-200">
      ...
      {/* Streak Saver Button */}
      <button className="w-full mt-4 px-4 py-2 text-blue-600 border border-blue-400 rounded-lg hover:bg-blue-50 transition">
        Get Streak Saver
      </button>
    </div>
  );
