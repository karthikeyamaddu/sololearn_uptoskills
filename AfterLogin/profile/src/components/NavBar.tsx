...
export default function Navbar() {
  ...
  const suggestions = [
    ...
    { term: 'discuss', path: '/discuss', category: 'Pages' },
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden lg:block relative">
              <button
                ...
                className="flex items-center space-x-2 px-4 py-3 text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors"
              >
                <BookOpen size={24} />
              ...
              <AnimatePresence>
                {isOpen && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0 }}
                    className="absolute left-0 mt-2 w-[800px] bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6"
                    onMouseEnter={() => setIsOpen(true)}
                    onMouseLeave={() => setIsOpen(false)}
                  >
                          ...
                          <div className="space-y-3">
                            {category.courses.map((course) => (
                              ...
                              >
                                ...
                                <div className="mt-2 w-full bg-gray-200 rounded-full h-2 dark:bg-gray-600">
                                  <div
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <Link to="/discuss" className="flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors">
          ...
          >
            <div className="px-4 pt-4 pb-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Link to="/discuss" className="block px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
                  Discuss
                </Link>
